...
---
For markets with multiple possible outcomes (e.g., "Which country wins the World Cup?"), all NO shares are the same SPL token across outcomes.
...
- France (YES/NO)
- Germany (YES/NO)
You hold 1,000 NO shares for Brazil. This means you believe Brazil won't win-someone else will.
To convert to Argentina:
<Steps>
