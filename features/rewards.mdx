...
Space rewards [makers](/concepts/makers-and-takers) for providing liquidity through placing limit orders and keeping markets balanced. Markets are only as good as the capital that holds them open - without deep order books, prices become unreliable and easily manipulated.
