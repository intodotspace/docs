...
---
Space rewards [makers](/features/clob/makers-and-takers) for providing liquidity through placing limit orders and keeping markets balanced. Markets are only as good as the capital that holds them open - without deep order books, prices become unreliable and easily manipulated.
...
1. **Duration-Based Rewards:** longer-dated markets receive higher reward multipliers. As shown in the Liquidity Reward Multiplier curve, markets resolving further in the future earn progressively higher rewards, with multipliers increasing significantly in the first 90 days and continuing to rise through year-long markets. \
\
...
2. **Quality Based Rewards:** Not all liquidity is equally valuable. The Commitment Quality Curve shows that orders placed near the balanced price of \$0.50 earn the highest rewards, while orders at extreme prices (\$0.05 or \$0.95) earn minimal rewards. \
\
...
## How It Works
Placing a limit order automatically enrolls you in liquidity rewards. Your reward allocation is calculated by combining:
Time until market resolution (duration multiplier)
Distance from balanced price (quality multiplier)
Size of your order relative to market depth
No special contracts or hidden mechanics - simply place limit orders and earn rewards while your capital provides market depth. The clearer the price signal your order helps establish, the more you earn.
Space's reward parameters are designed to maintain efficient capital allocation across all markets, ensuring that important but less-popular questions still attract the liquidity needed for reliable pricing.
