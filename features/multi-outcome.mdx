...
description: "Shared liquidity across related outcomes"
---
...
Each outcome has its own YES and NO [orderbook](/features/clob), but all outcomes are interconnected through a shared liquidity system and only one outcome can win like a multiple-choice question.
