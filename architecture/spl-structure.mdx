...
description: "How YES and NO tokens work on-chain"
---
...
If the [order book](/architecture/clob) is thin, you're never stuck. Mint a pair for \$1, sell the side you don't want. This creates your own liquidity without relying on other traders.
