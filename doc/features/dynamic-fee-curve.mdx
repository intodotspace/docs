...
Our dynamic fee curve is designed as an incentive alignment mechanism for [makers & takers](./clob/makers-and-takers) which uses fee asymmetry in order to achieve the following:

- Reward early participation, conviction and risk taking
- Maintain orderly books
- Reward makers for providing deeper liquidity (see more: [Rewards](./rewards))
...
**Shares you want to buy:** 1,000 of YES at \$0.30
...
import { DynamicFeeCurves } from "/snippets/dynamic-fee-curves.jsx"
