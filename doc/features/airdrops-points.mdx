...
Points measure meaningful participation on Space: trading, providing limit-order liquidity, referrals, and ongoing engagement. They are an auditable record Space uses when distributing airdrops. Points are a participation metric, not a token or guarantee of future rewards.
...
Airdrops on Space are a distribution tool, not a giveaway. They align ownership with the people who actually use the product—traders, liquidity providers, affiliates. Distributing tokens to real participants strengthens decentralization, widens governance, and rewards the behaviors that make markets liquid and reliable.
...
2. **Earn Points:** Trade, provide liquidity, engage, maintain streaks, and bring users via referrals.
