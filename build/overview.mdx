---
title: "Overview"
description: "What you can build on Space"
---
...
Space provides the infrastructure for prediction markets. Here are some examples of what developers will be able to build on top with data [pushed](/api/websocket) and and [pulled](/api/rest) from our platform.
