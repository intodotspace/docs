...
Prediction markets let you trade on [real-world outcomes](/features/categories). If you're right, you profit. If you're wrong, you lose. Markets aggregate these trades into probabilities that reflect collective belief about the future.
